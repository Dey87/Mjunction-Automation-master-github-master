...
public class TC_Auction_50ViewTheAuctionFromObserverAnyStage extends BaseClass_Web {
		...
		public void initializeRepository() throws Exception {
			...
			reportDetails.put("Test Script Revision No", "50");
		...
		@Test(description = "TC_Auction_050:View the auction from observer login at any stage")
	  public void validateAlertEventAlreadyExistedAndAuctionRuleInEventColumnTest(String no) throws Throwable {
		 ...
		 etendercomponentobj.tendercreatorLogin();
		  ...
		  auctioncomponentobj.selectStartBidPrice("Budgeted Rate");
		  ...
		  auctioncomponentobj.settingNewBidAsRateWise("1000","1000","1000");
		  ...
		  auctioncomponentobj.Activate_Aution(AuctionDate);
		  auctioncomponentobj.clickOnDetailsButton(decvalue);
		  auctioncomponentobj.settingNewBidAsRateWise("100","1000","1000");
		  etendercomponentobj.tenderLogout();
...
//		  //auctioncomponentobj.Activate_Aution(AuctionDate);
//		  auctioncomponentobj.clickOnDetailsButton(decvalue);
//		  auctioncomponentobj.settingNewBidAsRateWise1("100","100","1000");
//		  auctioncomponentobj.verifyRank1(decvalue);
//		  etendercomponentobj.tenderLogout();
		  
		  posttendercomponentobj.super_Admin_Login();
		  auctioncomponentobj.NavigaterToObserver(decvalue);
		  auctioncomponentobj.logoutTheAuction();
		}
