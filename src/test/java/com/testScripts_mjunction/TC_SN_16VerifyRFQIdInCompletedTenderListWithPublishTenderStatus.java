...
public class TC_SN_16VerifyRFQIdInCompletedTenderListWithPublishTenderStatus extends BaseClass_Web{
	...
	@Test(description = "Scenario:16 -Verify the tender in completed Tender List Page when Tender is in published Stage")
