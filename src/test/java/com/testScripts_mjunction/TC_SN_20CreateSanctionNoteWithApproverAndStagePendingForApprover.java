...
public class TC_SN_20CreateSanctionNoteWithApproverAndStagePendingForApprover extends BaseClass_Web{
	...
	@Test(description = "Scenario:20 - Create a sanction note with an approver and verify the sanction stage")
