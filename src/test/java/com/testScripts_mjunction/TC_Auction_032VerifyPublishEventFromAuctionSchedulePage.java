...
public class TC_Auction_032VerifyPublishEventFromAuctionSchedulePage extends BaseClass_Web {
	...
	@Test(description = "TC_Auction_032:Verify Publish Event from auction schedule page")
