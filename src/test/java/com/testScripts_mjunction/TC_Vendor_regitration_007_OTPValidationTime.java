...
public class TC_Vendor_regitration_007_OTPValidationTime extends BaseClass_Web {
	...
	@Test(description = "TC_Vendor_regitration_007_OTPValidationTime")
      public void OTPValidationTime(String no) throws Throwable {
	  ...
	  try {
		...
		VendorRegistrationComponent.VerifyOTPValidity();
