...
public class TC_SN_07IfSNTemplateIsReadyAgainstRFQTest extends BaseClass_Web {
	...
	public void initializeRepository() throws Exception {		
		...
		reportDetails.put("Test Script Revision No", "7");
	...
	@Test(description = "Scenario:7 - Sanction Note has prepared before processing of PO")
  public void f(String no) throws Throwable {
	  ...
	  posttendercomponentobj.CreateSanctionNoteWithNoApproval();
