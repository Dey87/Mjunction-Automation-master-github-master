...
public class TC_EPS_PO_06VerifyPurchaseOrderListInPOViewer extends BaseClass_Web{
	...
	@Test(description = "Scenario:06 -  Verify the Edit Icon in purchased order list after login the application with PO Viewer")
  public void f(String no) throws Throwable {
	  ...
	  postTenderComponent.verifyEditIconInPOViewer();
	}
}