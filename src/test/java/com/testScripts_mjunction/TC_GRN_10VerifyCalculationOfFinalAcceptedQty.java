...
public class TC_GRN_10VerifyCalculationOfFinalAcceptedQty extends BaseClass_Web{
	...
	@Test(description = "TC_GRN_10:Verify the Calculation of Final Accepted Quantity")
	  ...
	  try {
		...
		System.out.println("Unable to read the data from excel file");
         ...
         etendercomponentobj.openURL();
 		 ...
 		 asn_grncomponentobj.enterShortQty(1,"1.00");
 		 asn_grncomponentobj.enterDamageQty(1,"1.00");
 		 asn_grncomponentobj.getAcceptedQtyValueAndVerify(1,"12.00");
