...
public class TC_SN_28_Supplier_Item_Selection_Sanction_Note extends BaseClass_Web {
	...
	@Test(description = "Scenario:28 - For each supplier Template wise Items will be visible with check box.")
