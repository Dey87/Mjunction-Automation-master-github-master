...
public class TC_Corrigendum_05_DateCorrigendum_withApprovalReview_Closedstate extends BaseClass_Web{
...
//Creating a new tender with approval type Not Required
		...
		etendercomponentobj.Tender_WithOptionalItemsAndQtyEditableDateSchedule(8,9,29);
