...
public class TC_Auction_025_VerifyAlertEventAlreadyExisted extends BaseClass_Web{
	...
	@Test(description = "TC_Auction_025: VerifyAlertEventAlreadyExistedAndVerifyAuctionRuleInEventColumn")
