...
public class TC_SN_14VerifyRFQIdInCompletedTenderList extends BaseClass_Web{
	...
	@Test(description = "Scenario:14 -Verify the tender in post tender process")
  public void f(String no) throws Throwable {
	  ...
	  postTenderComponent.verifyRFQInPostTenderProcess();
	}
}