...
public class TC_EPS_PO_36_VerifyTheMailContentOfPOAcceptanceByBidderTest extends BaseClass_Web{
	...
	public void initializeRepository() throws Exception {		
		...
		reportDetails.put("Test Script Revision No", "36");
	...
	@Test(description = "Verify the mail when Po is accepted By Bidder")
  public void validemailContentOfPoAccetedByBidder(String no) throws Throwable {
	  ...
	  posttendercomponentobj.verifyMailSubjectAndMailBody("TEST_AUTOMATION has been accepted by CTS.", 10,"This is to inform you that","e-PROC SYSTEM TEAM.");
