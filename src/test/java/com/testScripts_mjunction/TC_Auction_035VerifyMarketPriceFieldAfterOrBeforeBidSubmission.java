...
public class TC_Auction_035VerifyMarketPriceFieldAfterOrBeforeBidSubmission extends BaseClass_Web {
	...
	@Test(description = "TC_Auction_035:Verify Market Price field not present after or before bid submission for bidder for Rank bidding")
