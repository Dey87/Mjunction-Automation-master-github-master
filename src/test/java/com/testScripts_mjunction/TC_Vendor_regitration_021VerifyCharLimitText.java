...
public class TC_Vendor_regitration_021VerifyCharLimitText extends BaseClass_Web {
	...
	@Test(description = "TC_Vendor_regitration_021VerifyCharLimitText")
      public void VerifyCharLimitText(String no) throws Throwable {
	  ...
	  try {
		...
		VendorRegistrationComponent.VerifyCharlimit();
