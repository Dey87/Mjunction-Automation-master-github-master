...
public class TC_Auction_016TenderWillBeInCompletedStatus extends BaseClass_Web{
	...
	@Test(description = "TC_Auction_016: Verify Creation of Reverse Auction from Draft Auction process with Default or customized terms and conditions with auction rule as Rank Bidding with  'Ranking-SBP' and bidding type as 'LOT-Itemwise Lumpsum'")
