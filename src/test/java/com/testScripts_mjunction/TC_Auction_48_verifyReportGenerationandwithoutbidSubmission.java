...
public class TC_Auction_48_verifyReportGenerationandwithoutbidSubmission extends BaseClass_Web {
	...
	@Test(description = "TC_Auction_48_verifyReportGenerationandwithoutbidSubmission")
  public void verifyReportGenerationandViewReport(String no) throws Throwable {
	 ...
	 etendercomponentobj.tendercreatorLogin();
	  ...
	  auctioncomponentobj.ScheduleTheEvent(1, 2, 4);
	  ...
	  auctioncomponentobj.searchTheTenderRefNumber();
	  auctioncomponentobj.downloadAllTypesReportsPDF();
	  auctioncomponentobj.logoutTheAuction();
