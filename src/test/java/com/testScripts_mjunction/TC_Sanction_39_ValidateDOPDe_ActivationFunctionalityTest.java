...
public class TC_Sanction_39_ValidateDOPDe_ActivationFunctionalityTest extends BaseClass_Web{
	...
	@Test(description = "Validate DOP DeActivation functionality")
	public void validateDop_DeActivation_Link(String no) throws Throwable {
		...
		posttendercomponentobj.clickOnCloseInSendForApproval_Sanction();
