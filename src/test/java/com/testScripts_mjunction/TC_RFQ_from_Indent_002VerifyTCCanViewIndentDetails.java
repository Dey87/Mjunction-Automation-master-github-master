...
public class TC_RFQ_from_Indent_002VerifyTCCanViewIndentDetails extends BaseClass_Web {
	...
	@Test(description = "TC_RFQ_from_Indent_002:Verify TC can View Indent details")
	  ...
	  try {
		...
		rfqfromintendcomponentobj.viewIndentPreviewDetails();
		rfqfromintendcomponentobj.clickIndentPreviewOkBtn();
