...
public class TC_Vendor_regitration_019UserAbleToFillUpBidderTemplateGroup extends BaseClass_Web {
	...
	@Test(description = "TC_Vendor_regitration_019UserAbleToFillUpBidderTemplateGroup")
      public void UserAbleToFillUpBidderTemplateGroup(String no) throws Throwable {
	  ...
	  try {
		...
		VendorRegistrationComponent.fillUpBidderTemplateGroup();
