...
public class TC_Vendor_regitration_002PANFieldIsDisplayed extends BaseClass_Web {
	...
	@Test(description = "TC_Vendor_regitration_002:Choosen County Is India PAN Field Is Displayed")
	  ...
	  try {
		...
		vendorregistrationcomponentobj.PANFieldValidationForIndiaCountry();
