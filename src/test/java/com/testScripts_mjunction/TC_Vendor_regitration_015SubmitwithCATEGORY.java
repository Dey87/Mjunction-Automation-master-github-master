...
public class TC_Vendor_regitration_015SubmitwithCATEGORY extends BaseClass_Web {
	...
	@Test(description = "TC_Vendor_regitration_015VerifysubmitwithItemCATEGORY")
      public void VerifysubmitwithItemCATEGORY(String no) throws Throwable {
	  ...
	  try {
		...
		VendorRegistrationComponent.VerifySubmitwithItemCategoryOnly();
