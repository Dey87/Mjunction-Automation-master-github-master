...
public class TC_Invoice_02InvoiceNumberDataValidation extends BaseClass_Web {
	...
	@Test(description = "TC_Invoice_02:InvoiceNumberDataValidation")
      public void InvoiceNumberDataValidation(String no) throws Throwable {
	  ...
	  try {
	    ...
	    invoicecomponentobj.invoiceNumberDataValidation();
