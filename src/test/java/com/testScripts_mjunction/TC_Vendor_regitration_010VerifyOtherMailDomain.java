...
public class TC_Vendor_regitration_010VerifyOtherMailDomain extends BaseClass_Web {
	...
	@Test(description = "TC_Vendor_regitration_010VerifyOtherMailDomain")
      public void VerifyOtherMailDomain(String no) throws Throwable {
