...
public class TC_Sanction_36_VerifyDOPCreationFunctionalityTest extends BaseClass_Web{
	...
	@Test(description = "verify Dop creation functionality Respective DOP will add in DOP list")
	public void validate_Respective_DopCreationFunctionality_Adding_In_DOPList(String no) throws Throwable {
		...
		posttendercomponentobj.verifyRespectiveDopIsAddedInDopList();
