...
public class TC_ASN_16UserShouldNotBeAbleToCreateASNFromCancelledPO extends BaseClass_Web{
	...
	@Test(description = "TC_ASN_16:User should not be able to create ASN from Cancelled PO")
  public void verifyUserShouldNotBeAbleToCreateASNFromCancelledPO(String no) throws Throwable {
	  ...
	  initializeRepository();
		...
		asn_grncomponentobj.verifyPoFromTheDropDownList(eTenderComponent.getDataFromPropertiesFile("poDocNum"), "Po Staus is Cancelled PO");
		etendercomponentobj.tenderLogout();
	}
