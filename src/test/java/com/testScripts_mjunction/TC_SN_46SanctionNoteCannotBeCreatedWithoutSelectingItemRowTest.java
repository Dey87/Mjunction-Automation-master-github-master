...
public class TC_SN_46SanctionNoteCannotBeCreatedWithoutSelectingItemRowTest extends BaseClass_Web {
	...
	@Test(description = "Scenario:46 - Sanction Note Creator should not be able to create Sanction Note without item.")
  public void f(String no) throws Throwable {
	  ...
	  posttendercomponentobj.itemRowSelectionAlertMessageValidation();
