...
public class TC_Vendor_regitration_004VerifyOtherOptionsWillGenerateInGeneralPage extends BaseClass_Web {
	...
	@Test(description = "TC_Vendor_regitration_004:Verify Other Options Will Generate In General Page")
      public void VerifyOtherOptionsWillGenerateInGeneralPageTest(String no) throws Throwable {
