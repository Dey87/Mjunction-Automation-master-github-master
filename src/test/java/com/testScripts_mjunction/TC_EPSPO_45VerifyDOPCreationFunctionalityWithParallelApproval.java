...
public class TC_EPSPO_45VerifyDOPCreationFunctionalityWithParallelApproval extends BaseClass_Web {
	...
	@Test(description = "verify Dop creation functionality in sanction module using parallel approval")
	public void validate_DopCreationFunctionality(String no) throws Throwable {
		...
		posttendercomponentobj.addUserForApprovalForCreatedDop2("PARALLEL");
