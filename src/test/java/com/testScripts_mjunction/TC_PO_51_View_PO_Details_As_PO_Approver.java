...
public class TC_PO_51_View_PO_Details_As_PO_Approver extends BaseClass_Web {
	...
	public void initializeRepository() throws Exception {		
		...
		reportDetails.put("Test Script Revision No", "51");
	...
	@Test(description = "Scenario:51 - Verify the functionality of view PO details as PO Approver")
  public void f(String no) throws Throwable {
	  ...
	  posttendercomponentobj.navigatePurchaseOrderApproval();
	  posttendercomponentobj.verifyPOFunctionalityofPOApprover();
	  etendercomponentobj.tenderLogout();
