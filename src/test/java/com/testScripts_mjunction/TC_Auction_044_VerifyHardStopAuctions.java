...
public class TC_Auction_044_VerifyHardStopAuctions extends BaseClass_Web {
	...
	@Test(description = "TC_Auction_44:TC_Auction_44_VerifyHardStopAuctionsInAuctionToBeReleasedTab")
  public void TC_Auction_43_VerifyStopButtonForLiveAuction(String no) throws Throwable {
	 ...
	 etendercomponentobj.tendercreatorLogin();
	  ...
	  auctioncomponentobj.VerifyHardStop();
	  auctioncomponentobj.logoutTheAuction();
	}
