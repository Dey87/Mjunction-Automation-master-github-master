...
public class TC_SN_33_ApprovalorRenewal_Sanction_Note extends BaseClass_Web {
	...
	@Test(description = "Scenario:33 - Verify the Approval functionality of Sanction Note")
