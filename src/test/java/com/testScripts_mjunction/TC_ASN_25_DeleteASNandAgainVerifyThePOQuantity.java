...
public class TC_ASN_25_DeleteASNandAgainVerifyThePOQuantity extends BaseClass_Web {
	...
	@Test(description = "TC_ASN_25_DeleteASNandAgainVerifyThePOQuantity")
	public void sanctionNoteCreationWorkFlow(String no) throws Throwable {
		...
		ASN_GRNComponent.TabWhatIamShippingWithBoxesOnlyPOQuantityVerify("15", "50", "µM");
		...
		ASN_GRNComponent.DeleteASN();

		ASN_GRNComponent.SearchDeletedPoInASNList();
		...
		ASN_GRNComponent.VerifyTheDeletedASN();
