...
public class TC_Auction_033VerifyUploadedTermsAndConditions extends BaseClass_Web {
	...
	@Test(description = "TC_Auction_033:Verify uploaded Terms And Conditions ")
  public void validateAlertEventAlreadyExistedAndAuctionRuleInEventColumnTest(String no) throws Throwable {
	 ...
	 etendercomponentobj.tendercreatorLogin();
	  ...
	  auctioncomponentobj.uploadFileUnderCustomizedTermsandConditions();
