...
public class TC_GRN_18_VerifyShipmentDetailsOFCreatedGRN extends BaseClass_Web {
	...
	@Test(description = "TC_GRN_18_VerifyShipmentDetailsOFCreatedGRN")
	public void TC_GRN_18_VerifyShipmentDetailsOFCreatedGRN(String no) throws Throwable {
		...
		ASN_GRNComponent.navigateToGrnListPage();
		...
		ASN_GRNComponent.ViewShipmentDetailsPage(ShipmentTrackingNum);
