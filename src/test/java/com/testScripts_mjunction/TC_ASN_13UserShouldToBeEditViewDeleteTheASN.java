...
public class TC_ASN_13UserShouldToBeEditViewDeleteTheASN extends BaseClass_Web {
	...
	public void initializeRepository() throws Exception {
		...
		reportDetails.put("Test Script Revision No", "013");
	...
	@Test(description = "TC_ASN_013:User should to be edit view delete the ASN")
  public void validateAlertEventAlreadyExistedAndAuctionRuleInEventColumnTest(String no) throws Throwable {
	  ...
	  asngrnComponent.navigateToASNListInBidderLogin();
	  asngrnComponent.verifyActionDropDownListElements(Arrays.asList("View", "Edit", "Delete"));
