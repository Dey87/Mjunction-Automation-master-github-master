...
public class TC_SN_06IfSNstageIsShowingGreenColourFunctionalityTest extends BaseClass_Web {
	...
	@Test(description = "Scenario:6 - Sanction Note has prepared before processing of PO")
  public void f(String no) throws Throwable {
	  ...
	  posttendercomponentobj.clickOnPOstageWhenSNStageIsInGreenColour();
