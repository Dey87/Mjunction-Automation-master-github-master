...
public class TC_Vendor_regitration_018CheckSearchOptionInOrganizationTab extends BaseClass_Web {
	...
	@Test(description = "TC_Vendor_regitration_018CheckSearchOptionInOrganizationTab")
      public void CheckSearchOptionInOrganizationTab(String no) throws Throwable {
	  ...
	  try {
		...
		VendorRegistrationComponent.passValueToMasterOrganizationList();
