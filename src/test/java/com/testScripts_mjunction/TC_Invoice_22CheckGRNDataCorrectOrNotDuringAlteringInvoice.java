...
public class TC_Invoice_22CheckGRNDataCorrectOrNotDuringAlteringInvoice extends BaseClass_Web {
	...
	@Test(description = "TC_Invoice_22:Check GRN data are correct or not during altering Invoice")
      public void CheckGRNdataCorrectOrNotDuringAlteringInvoiceTest(String no) throws Throwable {
	  ...
	  try {
		...
		initializeRepository();
	     ...
	     invoicecomponentobj.clickOnViewGRNInDisputedInvoicePage();
	     invoicecomponentobj.verifyGrnDataIsCorrectOrNot(etendercomponentobj.getDataFromPropertiesFile("ASNNum"),
	    		 etendercomponentobj.getDataFromPropertiesFile("ASNShippingTracking"), 
	    		 etendercomponentobj.getDataFromPropertiesFile("poDocNum"),
	    		 etendercomponentobj.getDataFromPropertiesFile("Bidder2") );
