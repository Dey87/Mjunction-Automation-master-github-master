...
public class TC_Vendor_regitration_006MobileNoFieldValidation extends BaseClass_Web {
	...
	@Test(description = "TC_Vendor_regitration_006:Mobile Number Field Validation")
      public void MobileNoFieldValidationTest(String no) throws Throwable {
	  ...
	  try {
		...
		vendorregistrationcomponentobj.mobileNumberFieldValidation();
