...
public class TC_Auction_040NotifyBiddersWithLeads extends BaseClass_Web {
	...
	@Test(description = "TC_Auction_040:Verify End to End flow with Auction Rule as 'English-No Ties' and bidding type 'LOT_Price'")
  public void validateAlertEventAlreadyExistedAndAuctionRuleInEventColumnTest(String no) throws Throwable {
	 ...
	 etendercomponentobj.bidder_01_Login();
	  ...
	  auctioncomponentobj.submitNewBidValue("4500000","4500000","4500000");
	  auctioncomponentobj.notifyBiddersWithLeadsIfHeRanksFirst(decvalue);
