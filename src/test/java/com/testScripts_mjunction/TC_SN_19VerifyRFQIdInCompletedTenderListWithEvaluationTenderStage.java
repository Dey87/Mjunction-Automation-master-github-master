...
public class TC_SN_19VerifyRFQIdInCompletedTenderListWithEvaluationTenderStage extends BaseClass_Web{
	...
	@Test(description = "Scenario:19 -Verify the tender in completed Tender List Page when Tender is in Evaluation Stage")
  public void f(String no) throws Throwable {
	...
	//Evaluation
		...
		etendercomponentobj.evaluationSendForApproval();
		etendercomponentobj.enterTenderIdInSearch();
