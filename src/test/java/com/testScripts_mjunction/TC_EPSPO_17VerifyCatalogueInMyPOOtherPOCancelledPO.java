...
public class TC_EPSPO_17VerifyCatalogueInMyPOOtherPOCancelledPO extends BaseClass_Web{
	...
	@Test(description = "Scenario:17 -  Verify the presence of Catalogue dropdown elements in MyPO, OthersPO and CancelledPO")
  public void f(String no) throws Throwable {
	  ...
	  postTenderComponent.catalogueDropdownsInAllPOTabs();
	}
}