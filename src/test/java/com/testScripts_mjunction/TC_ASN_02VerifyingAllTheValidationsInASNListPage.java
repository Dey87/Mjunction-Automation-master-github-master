...
public class TC_ASN_02VerifyingAllTheValidationsInASNListPage extends BaseClass_Web {
	...
	@Test(description = "TC_ASN_02:Verifying various validations in ASN List page")
  public void validateAlertEventAlreadyExistedAndAuctionRuleInEventColumnTest(String no) throws Throwable {
	  ...
	  asngrnComponent.verifyPOnumberIsDisplayed();
	  asngrnComponent.verifyStatus();
	  asngrnComponent.verifyColoumnVisibilityAndCreateASNButton();
