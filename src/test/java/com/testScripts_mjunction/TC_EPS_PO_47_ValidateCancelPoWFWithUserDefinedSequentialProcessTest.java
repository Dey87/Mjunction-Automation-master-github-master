...
public class TC_EPS_PO_47_ValidateCancelPoWFWithUserDefinedSequentialProcessTest extends BaseClass_Web {
	...
	@Test(description = "Verify the Functionality of User Defined Sequential Process  PO Cancellation WF")
	public void validateCancelPoWorkFlowWithUSerDefinedSeqProcess(String no) throws Throwable {
		...
		posttendercomponentobj.verifyActionDropDownElementsForCancelledPo();
		etendercomponentobj.tenderLogout();
