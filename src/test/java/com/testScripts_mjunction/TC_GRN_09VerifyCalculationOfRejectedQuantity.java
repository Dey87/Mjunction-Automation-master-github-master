...
public class TC_GRN_09VerifyCalculationOfRejectedQuantity extends BaseClass_Web{
	...
	public void initializeRepository() throws Exception {		
		...
		reportDetails.put("Test Script Revision No", "09");
	...
	@Test(description = "TC_GRN_09:Verify the Calculation of Rejected Quantity")
	  ...
	  try {
		...
		System.out.println("Unable to read the data from excel file");
         ...
         etendercomponentobj.openURL();
 		 ...
 		 asn_grncomponentobj.enterRejectedQty(1,"20.00");
 		 asn_grncomponentobj.enterDamageQty(1,"0.00");
 		 asn_grncomponentobj.getAcceptedQtyValueAndVerify(1,"0.00");
