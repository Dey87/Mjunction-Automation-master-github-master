...
public class TC_RFQ_from_Indent_005VerifyTCCanViewReversalHistory extends BaseClass_Web {
	...
	@Test(description = "TC_RFQ_from_Indent_005:Verify TC can view Reversal History")
      public void VerifyTCcanViewReversalHistoryTest(String no) throws Throwable {
	  ...
	  try {
		...
		rfqfromintendcomponentobj.clickOnIndentRevertFromActionMenu();
		rfqfromintendcomponentobj.enterTheRevertReasonAndSubmit();
		
		rfqfromintendcomponentobj.navigateToIndentAssignmentListPage();
		rfqfromintendcomponentobj.searchTheIntendNo(eTenderComponent.getDataFromPropertiesFile("SystemIndentNo"));
		rfqfromintendcomponentobj.clickOnIndentReversalHistoryFromActionMenu();
