...
public class TC_ASN_22_CreateASNWithoutInspectorRole extends BaseClass_Web {
	...
	@Test(description = "TC_ASN_22_CreateASNWithoutInspectorRole")
	public void sanctionNoteCreationWorkFlow(String no) throws Throwable {
		...
		ASN_GRNComponent.clickOnApproveOrRejectUnderActionDropdown();
