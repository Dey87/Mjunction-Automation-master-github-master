...
public class TC_Auction_029_E2E_FlowWithAuctionRuleDutchAndBiddingTypeNormalPart2Test extends BaseClass_Web {
	...
	public void initializeRepository() throws Exception {
		...
		reportDetails.put("Test Script Revision No", "29");
	...
	@Test(description = "TC_Auction_029_E2E_FlowWithAuctionRuleDutchAndBiddingTypeNormalPart2Test")
	public void validateStartPriceWillRemainSameBetweenStartTimeAndEndTime(String no) throws Throwable {
		...
		auctioncomponentobj.waitForAuctionBidEndTimeToReach(endTime, decvalue);
		...
		auctioncomponentobj.automaticallyNewBidValueWillBeIncrmentingWithPriceChangeInterval(decvalue,"4500000");
