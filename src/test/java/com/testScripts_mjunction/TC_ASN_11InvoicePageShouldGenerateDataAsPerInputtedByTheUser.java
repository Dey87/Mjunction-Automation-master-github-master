...
public class TC_ASN_11InvoicePageShouldGenerateDataAsPerInputtedByTheUser extends BaseClass_Web {
	...
	@Test(description = "TC_ASN_11:After saving the ASN data it should be displayed in listing page as draft")
  public void validateAlertEventAlreadyExistedAndAuctionRuleInEventColumnTest(String no) throws Throwable {
	  ...
	  asngrnComponent.SaveASN();
	  asngrnComponent.dataValidationForInvoiceTab();
