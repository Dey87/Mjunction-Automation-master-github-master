...
public class TC_EPS_PO_04VerifyPurchaseOrderList extends BaseClass_Web{
	...
	@Test(description = "Scenario:04 -  Verify the details of purchased order list after login the application with PO Creator")
