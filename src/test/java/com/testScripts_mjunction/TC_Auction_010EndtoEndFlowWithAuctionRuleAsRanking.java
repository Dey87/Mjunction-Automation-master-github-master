...
public class TC_Auction_010EndtoEndFlowWithAuctionRuleAsRanking extends BaseClass_Web {
	...
	@Test(description = "TC_Auction_010:Verify End to End flow with Auction Rule as 'Ranking-SBP' and bidding type as 'Normal'")
