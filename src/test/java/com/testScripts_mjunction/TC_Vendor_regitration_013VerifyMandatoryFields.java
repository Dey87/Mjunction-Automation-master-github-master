...
public class TC_Vendor_regitration_013VerifyMandatoryFields extends BaseClass_Web {
	...
	@Test(description = "TC_Vendor_regitration_013VerifyMandatoryFields")
      public void VerifyMandatoryFields(String no) throws Throwable {
	  ...
	  try {
		...
		VendorRegistrationComponent.VerifyFields();
		
		VendorRegistrationComponent.UserDetails();
		
		VendorRegistrationComponent.VerifyMobileandEmailDisabled();
		...
		VendorRegistrationComponent.NavigatedOtherTabs();
