...
public class TC_GRN_14VerifyTheFunctionalityOfGRNListPageOfCreatedGRNTest extends BaseClass_Web {
	...
	public void initializeRepository() throws Exception {
		...
		reportDetails.put("Test Script Revision No", "14");
	...
	@Test(description = "TC_GRN_14: VerifyTheFunctionalityOfGRNListPageOfCreatedGRNTest")
	public void validateTheFunctionalityOfGRNListPageOfCreatedGRN(String no) throws Throwable {
		...
		asn_grncomponentobj.validateActionMenuElementsInGrnListPage(eTenderComponent.getDataFromPropertiesFile("ASNShippingTracking"));
	
		asn_grncomponentobj.clickViewGrnDetailsInActionMenu(eTenderComponent.getDataFromPropertiesFile("ASNShippingTracking"));
		...
		asn_grncomponentobj.clickViewShipmentDetailsInActionMenu(eTenderComponent.getDataFromPropertiesFile("ASNShippingTracking"));
