...
public class TC_ASN_17UserShouldNotBeAbleToCreateASNFromRejectedPO extends BaseClass_Web{
	...
	@Test(description = "TC_ASN_17:User should not be able to create ASN from rejected PO")
  public void verifyUserShouldNotBeAbleToCreateASNFromRejectedPO(String no) throws Throwable {
	  ...
	  initializeRepository();
		...
		asn_grncomponentobj.verifyPoFromTheDropDownList(eTenderComponent.getDataFromPropertiesFile("poDocNum"), "Po Staus is Rejected PO");
		etendercomponentobj.tenderLogout();
