...
public class TC_Auction_039VerifyRankFieldForAuctionRule extends BaseClass_Web {
	...
	@Test(description = "TC_Auction_039:Verify Rank field for auction rule as 'Ranking-SBP' and bidding type as 'LOT_Itemwise Price' auction at Live auction page for bidder")
