...
public class TC_Vendor_regitration_008_VerifySaveButton extends BaseClass_Web {
	...
	@Test(description = "TC_Vendor_regitration_008_VerifySaveButton")
	  ...
	  try {
		...
		VendorRegistrationComponent.VerifySaveButton(); 
