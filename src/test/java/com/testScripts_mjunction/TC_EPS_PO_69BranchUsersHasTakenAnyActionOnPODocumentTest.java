...
public class TC_EPS_PO_69BranchUsersHasTakenAnyActionOnPODocumentTest extends BaseClass_Web {
	...
	public void initializeRepository() throws Exception {		
		...
		reportDetails.put("Test Script Revision No", "69");
	...
	@Test(description = "Scenario 69: - Branch users has taken any action on PO document ")
  public void f(String no) throws Throwable {
	  ...
	  posttendercomponentobj.provide_PO_ApproverComment();
	  posttendercomponentobj.clickOnApproverCommentSection();
	  posttendercomponentobj.ClickOnSendBackButton();
	  etendercomponentobj.tenderLogout();
	  
	  posttendercomponentobj.poApprover1Login();
	  posttendercomponentobj.navigateToApprovalPendingPage();
	  posttendercomponentobj.navigateTo_PurchaseOrder_Approval();
	  posttendercomponentobj.clickOnBranchSectionApproverComment();
