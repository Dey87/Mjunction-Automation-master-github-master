...
public class TC_EPS_PO_32CheckingBidderIsAbleToAcceptPOorNotTest extends BaseClass_Web {
	...
	@Test(description = "Scenario:32 Checking Bidder is able to accept PO or not-")
