...
public class TC_EPS_PO_34_VerifyTheMailContentOfOnPOReleaseTest extends BaseClass_Web {
  ...
  public void f(String no) throws Throwable {
	  ...
	  posttendercomponentobj.verifyMailSubjectAndMailBody("TEST_AUTOMATION HAS BEEN RELEASED", 10,"This is to inform you that","e-PROC SYSTEM TEAM.");
	  
	 // posttendercomponentobj.verifyLatestTriggeredMailBody("This is to inform you that","e-PROC SYSTEM TEAM.,10");
	  
	 /* posttendercomponentobj.verifyLatestTriggeredMailSubject();
	  
	  posttendercomponentobj.verifyLatestTriggeredMailBody("This is to inform you that","e-PROC SYSTEM TEAM.");
	  */
