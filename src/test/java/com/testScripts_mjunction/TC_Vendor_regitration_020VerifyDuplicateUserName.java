...
public class TC_Vendor_regitration_020VerifyDuplicateUserName extends BaseClass_Web {
	...
	@Test(description = "TC_Vendor_regitration_020VerifyDuplicateUserName")
      public void VerifyDuplicateUserName(String no) throws Throwable {
	  ...
	  try {
		...
		VendorRegistrationComponent.Addorganization();
		
		VendorRegistrationComponent.VerifyDuplicateUserID();
