...
public class TC_Vendor_regitration_016TRNCheckForPreviousData extends BaseClass_Web {
	...
	public void initializeRepository() throws Exception {
		...
		reportDetails.put("Test Script Revision No", "16");
	...
	@Test(description = "TC_Vendor_regitration_016AfterTRNCheckForPreviousData")
      public void AfterTRNCheckForPreviousData(String no) throws Throwable {
	  ...
	  try {
		...
		VendorRegistrationComponent.EnterOTP();
		
		VendorRegistrationComponent.VerifyOtherTabs();
		
		etendercomponentobj.openURL();
		
        VendorRegistrationComponent.ClickOnBidderRegistration();
		
		VendorRegistrationComponent.SelectContinueWithTRN();
		
		VendorRegistrationComponent.WaitforOTP();
		
		VendorRegistrationComponent.EnterTRNnumber();
		
		VendorRegistrationComponent.bidderRegristrationForm();
