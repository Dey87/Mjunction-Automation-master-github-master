...
public class TC_Auction_036VerifyStartBidPriceFieldIsShowing extends BaseClass_Web {
	...
	@Test(description = "TC_Auction_036:Verify start bid price field is showing as Not Applicable to the observer")
  public void validateAlertEventAlreadyExistedAndAuctionRuleInEventColumnTest(String no) throws Throwable {
	  ...
	  auctioncomponentobj.clickOnObserver();
	  auctioncomponentobj.VerifyStartPriceFieldStatus(decvalue);
	  auctioncomponentobj.logoutTheAuction();
