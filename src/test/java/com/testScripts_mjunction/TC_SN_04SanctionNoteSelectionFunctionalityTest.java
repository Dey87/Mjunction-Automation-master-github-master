...
public class TC_SN_04SanctionNoteSelectionFunctionalityTest extends BaseClass_Web {
	...
	@Test(description = "Scenario:4 - Sanction Note has prepared before processing of PO")
