...
public class TC_SN_25RejectedBidderListUnderRejectedSupplierList extends BaseClass_Web{
	...
	@Test(description = "Scenario:25 - Create a sanction note with approver and verify the sanction stage after recall")
  public void f(String no) throws Throwable {
	  ...
	  postTenderComponent.checkTheRejectedBiddersList();
