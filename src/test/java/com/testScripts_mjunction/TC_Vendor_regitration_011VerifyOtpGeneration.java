...
public class TC_Vendor_regitration_011VerifyOtpGeneration extends BaseClass_Web {
	...
	@Test(description = "TC_Vendor_regitration_011VerifyOtpGeneration")
      public void VerifyOtpGeneration(String no) throws Throwable {
