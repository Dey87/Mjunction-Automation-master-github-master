...
public class TC_Vendor_regitration_001CheckForBidderRegistrationForm extends BaseClass_Web {
	...
	@Test(description = "TC_Vendor_regitration_001:Choose Country As India Check For BidderRegistration Form")
      public void CheckForBidderRegistrationFormTest(String no) throws Throwable {
	  ...
	  try {
		...
		vendorregistrationcomponentobj.bidderRegristrationFormValidation();
