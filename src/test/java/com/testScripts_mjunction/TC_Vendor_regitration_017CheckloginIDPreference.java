...
public class TC_Vendor_regitration_017CheckloginIDPreference extends BaseClass_Web {
	...
	@Test(description = "TC_Vendor_regitration_017CheckloginIDPreference")
      public void CheckloginIDPreference(String no) throws Throwable {
	  ...
	  try {
		...
		VendorRegistrationComponent.SubmitPreferredUserName();
