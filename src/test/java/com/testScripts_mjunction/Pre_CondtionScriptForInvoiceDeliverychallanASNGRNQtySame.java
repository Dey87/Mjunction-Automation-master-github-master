...
public  class Pre_CondtionScriptForInvoiceDeliverychallanASNGRNQtySame extends BaseClass_Web {
	...
	@Test(description = "Pre_CondtionScriptForInvoiceDeliverychallanASNGRNQtySame")
	public void sanctionNoteCreationWorkFlow(String no) throws Throwable {
		...
		etendercomponentobj.tenderLogout();
		 ...
		 asn_grncomponentobj.TabInvoice("Delivery challan");
		 asn_grncomponentobj.SaveASN();
