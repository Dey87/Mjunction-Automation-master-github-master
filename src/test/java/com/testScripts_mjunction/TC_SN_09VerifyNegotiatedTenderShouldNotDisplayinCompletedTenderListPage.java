...
public class TC_SN_09VerifyNegotiatedTenderShouldNotDisplayinCompletedTenderListPage extends BaseClass_Web {
	...
	@Test(description = "Scenario:9 - Verify Negotiated Tender Should Not Display in Completed Tender List Page")
