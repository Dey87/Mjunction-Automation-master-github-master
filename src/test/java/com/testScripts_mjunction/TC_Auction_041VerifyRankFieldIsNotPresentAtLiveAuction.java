...
public class TC_Auction_041VerifyRankFieldIsNotPresentAtLiveAuction extends BaseClass_Web {
	...
	public void initializeRepository() throws Exception {
		...
		reportDetails.put("Test Script Revision No", "41");
	...
	@Test(description = "TC_Auction_041:Verify Rank field is not present at live auction page after or before bid submission for Auction Controller")
  public void validateAlertEventAlreadyExistedAndAuctionRuleInEventColumnTest(String no) throws Throwable {
	  ...
	  auctioncomponentobj.VerifyRankFieldIsNotPresentAtLiveAuctionPageBeforeBidSubmission(decvalue);
	  auctioncomponentobj.logoutTheAuction();
	  ...
	  auctioncomponentobj.navigateToAuctionPlatform();
	  auctioncomponentobj.clickOnAuctionListForController();
	  auctioncomponentobj.VerifyRankFieldIsNotPresentAtLiveAuctionPageAfterBidSubmission(decvalue);
	  auctioncomponentobj.logoutTheAuction();
