...
public class TC_SN_17VerifyRFQIdInCompletedTenderListWithOpenForBidSubmissionTenderStage extends BaseClass_Web{
	...
	@Test(description = "Scenario:17 -Verify the tender in completed Tender List Page when Tender is in Open for bid submission stage")
