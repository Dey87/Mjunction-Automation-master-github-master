...
public class Pre_CondtionScriptForDisputedInvoiceInInvoiceAndPaymentModule extends BaseClass_Web {
	...
	public PostTenderComponent posttendercomponentobj =new PostTenderComponent(pdfResultReport);
	 ...
	 public InvoiceComponent invoiceobj=new InvoiceComponent(pdfResultReport);
	/**
	...
	@Test(description = "Pre_CondtionScriptForDisputedInvoiceInInvoiceAndPaymentModule")
	public void sanctionNoteCreationWorkFlow(String no) throws Throwable {
		...
		invoiceobj.searchPoRefNoInPoListPage1();
		invoiceobj.clickAcceptPoInDropDown1();
