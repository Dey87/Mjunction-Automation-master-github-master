...
public class TC_EPSPO_16VerifyCatalogueInMyPOOtherPOCancelledPO extends BaseClass_Web{
	...
	@Test(description = "Scenario:16 -  Verify the presence of Catalogue dropdown elements in MyPO, OthersPO and CancelledPO")
