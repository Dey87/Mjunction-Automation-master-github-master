...
public  class TC_ASN_05_12AfterSavingTheASNdataItShouldBeDisplayedInListingPageAsDraft extends BaseClass_Web {
	...
	public void initializeRepository() throws Exception {
		...
		reportDetails.put("Test Script Revision No", "05,12");
	...
	@Test(description = "TC_ASN_05,12:After saving the ASN data it should be displayed in listing page as draft")
  public void validateAlertEventAlreadyExistedAndAuctionRuleInEventColumnTest(String no) throws Throwable {
	  ...
	  asngrnComponent.navigateToASNListInBidderLogin();
	  asngrnComponent.verifyDraftStatus();
