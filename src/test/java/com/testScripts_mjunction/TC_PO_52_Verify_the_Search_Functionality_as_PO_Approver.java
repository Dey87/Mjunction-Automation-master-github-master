...
public class TC_PO_52_Verify_the_Search_Functionality_as_PO_Approver extends BaseClass_Web {
	...
	public void initializeRepository() throws Exception {		
		...
		reportDetails.put("Test Script Revision No", "52");
	...
	@Test(description = "Scenario:52 - Verify the Search Functionality as PO Approver")
  public void f(String no) throws Throwable {
	  ...
	  posttendercomponentobj.SearchfunctinalityasPO_Approver();
	  etendercomponentobj.tenderLogout();
