...
public class TenderWithCompletedStatusWorkFlowWithThreeBiddersTest extends BaseClass_Web {
	...
	@Test(description = "TenderWithCompletedStatusWorkFlowWithThreeBiddersTest")
	public void tenderWithCompletedStatusWorkFlowWithThreeBiddersTest(String no) throws Throwable {
		...
		for (i = 0; i <= 30; i++) {
			...
			etendercomponentobj.Tender_WithOptionalItemsAndQtyEditableGeneralInfoWithThreeBidders(
			...
			etendercomponentobj.mandatoryFieldValidation_BoqmandatoryTab(
					eTenderComponent.getDataFromPropertiesFile("Bidder1SupplierQty"),
					eTenderComponent.getDataFromPropertiesFile("Bidder1BudgetRate"));
			...
			etendercomponentobj.mandatoryFieldValidation_commercialTab_bidsubmission();
			etendercomponentobj.mandatoryFieldValidation_BoqmandatoryTab(
					eTenderComponent.getDataFromPropertiesFile("Bidder2SupplierQty"),
					eTenderComponent.getDataFromPropertiesFile("Bidder2BudgetRate"));
			etendercomponentobj.mandatoryFieldValidation_submitButton_bidsubmission();
			...
			etendercomponentobj.mandatoryFieldValidation_commercialTab_bidsubmission();
			etendercomponentobj.mandatoryFieldValidation_BoqmandatoryTab(
					eTenderComponent.getDataFromPropertiesFile("Bidder3SupplierQty"),
					eTenderComponent.getDataFromPropertiesFile("Bidder3BudgetRate"));
			etendercomponentobj.mandatoryFieldValidation_submitButton_bidsubmission();
			...
			etendercomponentobj.clickEditableLinkPendingStatusAndSelectRejectForTheBidder("TECH_AUTO_01",
					"Tech Mahindra test (TECH_AUTO_01) is successfully Rejected");

			etendercomponentobj.enterOverallComment();

			etendercomponentobj.enterTenderIdInSearch();

			etendercomponentobj.UpdateCompletedTenderIdInPropertyFile(i);
